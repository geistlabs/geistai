          ...
          onComplete: () => {
            ...
            if (currentChatId && storage.addMessage && accumulatedContent) {
              ...
              if (memoryManager.isInitialized) {
                console.log(
                  '[Memory] 🧠 Starting memory extraction and storage process...',
                );
                ...
                memoryManager
                  ...
                  .then(memories => {
                    console.log(
                      '[Memory] 🧠 Extraction completed, memories found:',
                      memories.length,
                    );
                    if (memories.length > 0) {
                      console.log(
                        '[Memory] 🧠 Storing memories in local database...',
                      );
                  ...
                  .catch(err => {
                    console.error(
                      '[Memory] 🧠 ❌ Failed to extract/store memories:',
                      err,
                    );
                    console.error(
